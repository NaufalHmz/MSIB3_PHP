...
class Pegawai{
    ...
    public function setGajiBersih(){
        $gasih = $this->setGapok() + $this->setTunjab() + $this->setTunkel() + $this->setZakatProfesi();
        return $gasih;
    }
    public function mencetak(){
        ...
        echo '<br/>Gaji Pokok: '.$this->setGapok($this->gapok);
        echo '<br/>Tunjangan Jabatan: '.$this->setTunjab($this->tunjab);
        echo '<br/>Tunjangan Keluarga: '.$this->setTunkel($this->tunkel);
        echo '<br/>Zakat: '.$this->setZakatProfesi($this->zakat);
        echo '<br/>Gaji Bersih: '.$this->setGajiBersih($this->gasih);
        echo '<hr/>';
    }
}